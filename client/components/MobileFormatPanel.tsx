...
export default function MobileFormatPanel({
  isOpen,
  onClose,
  onSave,
  disabled,
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 lg:hidden" onClick={onClose}>
      <div
        className="fixed bottom-0 left-0 right-0 bg-white rounded-t-xl shadow-lg max-h-[90vh] overflow-y-auto"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="sticky top-0 bg-white border-b border-[#EFF2F7] p-4 flex items-center justify-between">
          <h2 className="text-lg font-medium">Форматирование</h2>
          <button
            onClick={onClose}
        ...
        {!selectedQuestion ? (
          <div className="p-4 flex items-center justify-center text-gray-400">
            <p>Выберите вопрос для форматирования</p>
          </div>
        ) : (
                ...
                <div className="flex gap-1 p-1 bg-[#EFF2F7] rounded-xl">
                  ...
                  >
                    <svg
                      ...
                      fill="none"
                    >
                      <g clipPath="url(#clip0_align_center_v_mobile)">
                        <path
                      ...
                      <defs>
                        <clipPath id="clip0_align_center_v_mobile">
                ...
                <div className="flex gap-1 p-1 bg-[#EFF2F7] rounded-xl">
                  ...
                  >
                    <svg
                      ...
                      fill="none"
                    >
                      <g clipPath="url(#clip0_align_center_h_mobile)">
                        <path
                      ...
                      <defs>
                        <clipPath id="clip0_align_center_h_mobile">
                          <rect width="20" height="20" fill="white" />
                        </clipPath>
                      </defs>
                    </svg>
                  ...
                  >
                    ...
                    >
                      <path
                        ...
                        stroke="black"
                        strokeOpacity={
                          verticalAlignment === "bottom" ? "1" : "0.4"
                        }
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
            ...
            <div className="border-t border-[#EFF2F7] pt-6">
              ...
              <div className="flex gap-2 mb-3">
                <select
                  ...
                  className="flex-1 px-3 py-2 bg-[#EFF2F7] rounded-xl border-none outline-none text-black/80 text-[15px]"
                >
              ...
              <div className="flex gap-2 mb-3">
                <select
                  value={fontWeight}
                  onChange={(e) =>
                    handleFontWeightChange(e.target.value as "400" | "700")
                  }
                  className="flex-1 px-3 py-2 bg-[#EFF2F7] rounded-xl border-none outline-none text-black/80 text-[15px]"
                >
                ...
                <input
                  ...
                  className="w-20 px-3 py-2 bg-[#EFF2F7] rounded-xl border-none outline-none text-black/80 text-[15px]"
                  min="8"
                  max="72"
                />
              </div>
              <div className="flex items-center px-3 py-[3px] bg-[#EFF2F7] rounded-xl gap-2">
                <input
                  type="text"
                ...
                >
                  ...
                  >
                    <path
                      d="M2 7H12"
                      stroke={
                        isStrikethrough ? "#262626" : "rgba(0, 0, 0, 0.4)"
                      }
                      strokeWidth="1.5"
                      strokeLinecap="round"
                    />
                    <path
                      d="M4 3.5C4 3 4.5 2 6 2H8C9.5 2 10 3 10 3.5V5.5"
                      stroke={
                        isStrikethrough ? "#262626" : "rgba(0, 0, 0, 0.4)"
                      }
                      strokeWidth="1.5"
                    ...
                    />
                    <path
                      d="M10 8.5V10.5C10 11 9.5 12 8 12H6C4.5 12 4 11 4 10.5V8.5"
                      stroke={
                        isStrikethrough ? "#262626" : "rgba(0, 0, 0, 0.4)"
                      }
                      strokeWidth="1.5"
